				...
				<swiper-item v-for="(tab,index1) in newsitems" :key="index1">
					<scroll-view class="list" scroll-y @scroll="scroll" @scrolltolower="loadMore(index1)" @touchstart="touchmove($event,index1)">
						...
						<view v-show="tabIndex==0">
							<view class="activify">
								<view class="uni-flex uni-row">
									<view class="text" @tap="pthd(1577771853641)" style="-webkit-flex: 1;flex: 1;">
										<image src="../../static/tbnhj.jpg" mode=""></image>
									</view><!-- 1577675754763聚划算主会场  1523430244779天猫超市 1577679426294食品年会会场-->
									<view class="text" @tap="pthd(1577675754763)" style="-webkit-flex: 1;flex: 1;">
										<image src="https://img.alicdn.com/tfs/TB1KmBnr8v0gK0jSZKbXXbK2FXa-440-180.jpg" mode=""></image>
									</view>
								</view>
								<view class="uni-flex uni-row">
									<!-- 1565151108610天猫活动  1577675754782天猫超市主会场 -->
									<view class="text" @tap="pthd(1577675754782)" style="-webkit-flex: 1;flex: 1;">
										<image src="https://img.alicdn.com/tfs/TB1euc0sKL2gK0jSZFmXXc7iXXa-440-180.jpg" mode=""></image>
									</view>
									<!-- 1577675754758服装主会场   1563282628203天猫zy-->
									<view class="text" @tap="pthd(1577675754758)" style="-webkit-flex: 1;flex: 1;">
										<image src="https://img.alicdn.com/tfs/TB123IZrKL2gK0jSZFmXXc7iXXa-440-180.png" mode=""></image>
									</view>
								</view>
							</view>
							<!-- 横向混动 -->
							...
							<uni-segmented-control v-show="tabIndex==0" :current="current" :values="items" :style-type="styleType"
						...
						<view v-show="tabIndex!=0">
							<uni-grid class="tabList" :options="tabBars[tabIndex].childTabs" @click="tabClick" :show-border="false"
							 :column-num="tabIndex==0?5:4" />
							<!-- <sort @click="screentap" :sortTabFixed="sortTabFixed" :tabIndex="tabIndex" :isDefault="isDefault" :isPrice="isPrice" :isTk_rate="isTk_rate" :isTotal_sales="isTotal_sales"></sort> -->
